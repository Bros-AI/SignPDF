...
(function () {
    ...
    const STRINGS = {
        en: {
            ...
            footerMade: 'Created with',
            footerPrivacy: 'Your files never leave your device.',
            footerShare: '🔗 Share',
            supportTitle: 'Your PDF is on its way!',
            supportSubtitle: 'SignPDF is free and open source. If it saved you time, a star or a share helps enormously!',
            supportStar: 'Star the project',
            supportContribute: 'Contribute on GitHub',
            shareTitle: 'Share SignPDF',
            shareCopy: 'Copy',
            shareCopied: 'Link copied!',
            supportLater: 'Maybe later',
            shareText: 'SignPDF — sign, initial and stamp your PDFs for free, 100% in the browser. Your files never leave your device.',
            // Runtime messages
        ...
        fr: {
            ...
            footerMade: 'Créé avec',
            footerPrivacy: 'Vos fichiers ne quittent jamais votre appareil.',
            footerShare: '🔗 Partager',
            supportTitle: 'Votre PDF arrive !',
            supportSubtitle: 'SignPDF est gratuit et open source. S’il vous a fait gagner du temps, une étoile ou un partage aide énormément !',
            supportStar: 'Star le projet',
            supportContribute: 'Contribuer sur GitHub',
            shareTitle: 'Partager SignPDF',
            shareCopy: 'Copier',
            shareCopied: 'Lien copié !',
            supportLater: 'Plus tard',
            shareText: 'SignPDF — signez, paraphez et tamponnez vos PDF gratuitement, 100% dans le navigateur. Vos fichiers ne quittent jamais votre appareil.',
